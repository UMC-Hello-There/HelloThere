...
public class Report {
    ...
    public Report createReport(String reason, Long boardId, Long commentId, String chatRoomId, User reporter, User reported) {
        ...
        report.setChatRoomId(chatRoomId == null ? "" : chatRoomId);
